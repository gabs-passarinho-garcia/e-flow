          ...
          <div className="flex flex-col gap-6 pb-6">
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs truncate max-w-[200px] mt-0.5">
                    {station.address}
                  </p>
                </div>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="text-[#5B4EFF] text-xs font-bold hover:underline">
                  Alterar
                </button>
              </div>
                ...
                {paymentMethods.map((method) => (
                  ...
                  >
                    <div className="flex-1 flex items-center gap-3">
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center ${selectedMethod === method.id ? 'bg-white border border-gray-100' : 'bg-gray-100'}`}
                      >
