    ...
    <div className="h-screen w-full relative overflow-hidden bg-gray-100">
      ...
      <div className="absolute right-5 bottom-44 flex flex-col gap-4 z-[1000]">
        <button 
          type="button"
          aria-label="Filtros"
          className="w-14 h-14 bg-white rounded-full shadow-float flex items-center justify-center text-gray-700 hover:bg-gray-50 active:scale-95 transition-transform"
        >
      ...
      {/* Banner de Rota Ativa (Movido para cima para não colidir) */}
      ...
      {/* Barra de Navegação Inferior (Grid Flexível) */}
      <div className="absolute bottom-8 left-6 right-6 h-20 bg-white rounded-[2rem] shadow-float z-[1000] flex items-center justify-evenly px-2">
        
        {/* Item 1: Início */}
        <button 
          type="button"
          className="flex flex-col items-center gap-1 text-gray-400 hover:text-gray-900 transition-colors w-16"
        >
        ...
        {/* Item 3: Botão Central (Pop-out via margem negativa) */}
        <div className="relative -mt-12 w-16 flex justify-center">
          <button 
            type="button"
            aria-label="Ação Principal"
            className="w-16 h-16 bg-primary-400 rounded-full shadow-lg border-4 border-white flex items-center justify-center transition-transform active:scale-90 hover:brightness-105"
          >
