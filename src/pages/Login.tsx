...
export default function Login(): JSX.Element {
  ...
  return (
    // CORREÇÃO: h-full ocupa exatamente o espaço disponível no #root
    // overflow-y-auto permite rolar o conteúdo DENTRO deste container
    <div className="h-full w-full bg-white overflow-y-auto">
      {/* Container interno:
          - min-h-full: Garante que o conteúdo ocupe pelo menos a altura total (para centralizar)
          - pb-40: Adiciona MUITO espaço no final para garantir que o teclado ou barras do navegador não cubram o botão
      */}
      <div className="min-h-full flex flex-col items-center px-4 sm:px-8 py-8 pb-40">
