        ...
        <div className="px-6 pb-8 -mt-6 relative bg-white rounded-t-[32px]">
          ...
          <div className="flex justify-between items-start mb-2">
            <div className="flex gap-3">
              ...
              <div>
                <h2
                  id="station-name"
                  className="text-2xl font-bold text-gray-900 leading-none mb-1"
                >
                  {station.name}
                </h2>
            ...
            <div className="flex gap-3 text-gray-400">
              <button aria-label="Salvar estação">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <button aria-label="Compartilhar estação">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex gap-1">
              {[1, 2, 3, 4].map((i) => (
                <svg key={i} className="w-5 h-5 text-[#FF4C24] fill-current" viewBox="0 0 24 24">
                  <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                </svg>
              ))}
              <svg
                className="w-5 h-5 text-[#FF4C24]"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
          ...
          <div className="flex border-b border-gray-200 mb-6">
            <button className="pb-3 border-b-2 border-gray-900 font-semibold text-gray-900 flex-1">
              Visão Geral
            </button>
            <button className="pb-3 border-b-2 border-transparent font-medium text-gray-400 flex-1">
              Avaliações
            </button>
          </div>
